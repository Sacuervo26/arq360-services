...
const nextConfig:NextConfig={
  ...
  async redirects(){return [
    {source:"/ejemplos",destination:"/servicios",permanent:true},
    {source:"/ejemplos/:slug",destination:"/servicios/:slug",permanent:true},
    ...
    {source:"/proyectos",destination:"/sectores",permanent:true},
    {source:"/proyectos/:slug",destination:"/sectores",permanent:true},
